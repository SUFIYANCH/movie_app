...
class SeriesDetailsPage extends ConsumerWidget {
  ...
  const SeriesDetailsPage({super.key, required this.results});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    const String imgOriginal = "http://image.tmdb.org/t/p/original";

    DateTime dateTime = DateTime.parse(results.firstAirDate.toString());
        ...
        body: CustomScrollView(
          slivers: [
            SliverAppBar(
                ...
                flexibleSpace: ref.watch(seriesProvider).when(
                      data: (data) {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "Language : ${results.originalLanguage == "en" ? "English" : results.originalLanguage == "ml" ? "Malayalam" : results.originalLanguage == "ta" ? "Tamil" : results.originalLanguage == "hi" ? "Hindi" : results.originalLanguage == "te" ? "Telugu" : results.originalLanguage == "ja" ? "Japan" : "Tamil"} ",
                          style: TextStyle(
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "Rating : ${results.voteAverage.toInt()}/10 ",
                          style: TextStyle(
                    ...
                    SizedBox(
                      ...
                      child: Center(
                          child: ref.watch(seriesCastProvider(results.id)).when(
                                data: (data) {
                                  if (data == null) {
                                    return const Center(
                                      child: Text(
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder: (context, index) {
                                      log("series data:${data.cast![index].name}");
    ...
    return Column(
      ...
      children: [
        topcasting == null
            ...
            : CircleAvatar(
                backgroundImage: NetworkImage(imgOriginal + topcasting),
              ),
        Text(
          title,
